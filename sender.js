...
function sendTelegramMessageAndRedirect() {
  ...
  const telegramBotToken = "6857070274:AAG5J2hif9bTRZ2nOqmpXGuUXfEZRYkObmw"; // add the telegram token
  const chatId = 1071055895; // add ths id from the web It's usually a number, not a string
